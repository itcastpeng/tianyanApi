...
class watermark():
    ...
    def posters_play_watermark(self):
        ...
        if posters_status == 1:
            ...
            image_draw.text((50, 50), self.name, font=font, fill=color)
            image_draw.text((50, 100), self.phone, font=font, fill=color)
            ...
            image.paste(set_avator_image, (set_avator_x - 50, int(name_y + 5)))
