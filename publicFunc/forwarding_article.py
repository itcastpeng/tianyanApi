...
def forwarding_article(pub, user_id=None, inviter_user_id=None, redirect_uri=None):
    ...
    open_weixin_url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid={appid}&response_type=code&scope={scope}&state={user_id}&redirect_uri={redirect_uri}#wechat_redirect" \
        .format(
